...
const IframeSlide: React.FC<IframeSlideProps> = ({
	...
	return (
		<div className={`relative rounded-[16px] ${border ? "bg-gradient-to-r from-blue-500 to-indigo-600" : ""} p-[2px]`}>
			<div className={`absolute inset-0 rounded-[16px] ${border ? "bg-gradient-to-r from-blue-500 to-indigo-600" : ""}opacity-50 blur-md`} />
